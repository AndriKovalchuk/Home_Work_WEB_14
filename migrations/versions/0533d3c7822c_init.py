...
Revision ID: 0533d3c7822c
Revises: 
Create Date: 2024-03-27 22:07:44.570269
...
def upgrade() -> None:
    ...
    sa.Column('additional_information', sa.String(length=250), nullable=True),
